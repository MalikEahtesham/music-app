...
import { rV,rS,rMS} from '../shared/responsive';
  ...
  const AlbummList: any = [
    {
      "id": 1,
      title: "The triangle",
      image: require('../assets/Rectangle_16.png') //../assets/Rectangle_16.png
    },
    {
      "id": 2,
      title: "Dune Of Visa",
      image: require('../assets/Rectangle_17.png')
    },
    {
      "id": 3,
      title: "Riskitall",
      image: require('../assets/Rectangle_18.png')
    },
    {
      "id": 4,
      title: "Riskitall Of Visa",
      image: require('../assets/Rectangle_16.png')
    }
  ]
